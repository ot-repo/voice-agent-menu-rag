...
CREATE INDEX IF NOT EXISTS idx_menu_categories_name_bm25 ON menu_categories USING bm25(name) WITH (text_config='german', k1=1.2, b=0.75);
CREATE INDEX IF NOT EXISTS idx_menu_categories_label_bm25 ON menu_categories USING bm25(label) WITH (text_config='german', k1=1.2, b=0.75);
